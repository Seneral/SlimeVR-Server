...
function initializePreview(
  ...
  const gridSize = 20, gridDiv = 100, gridSpacing = gridSize/gridDiv;
  ...
  const computeSkeletonPos = (bones: Map<BodyPart, BoneT>) => {
    ...
    const offset = (yLength as BoneT[]).reduce((prev, cur) => prev + cur.boneLength, 0)
  ...
  return {
    ...
    updatesBones: (bones: Map<BodyPart, BoneT>) => {
      ...
      grid.position.set(-skeletonPos.x % gridSpacing, 0, -skeletonPos.z % gridSpacing);
    },
    destroy: () => {
